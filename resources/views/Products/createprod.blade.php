                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="px-3">
                                    ...
                                    <form class="form" action="{{ route('store-product') }}" method="post">
                                        @csrf
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="code" class="form-control round" name="category_id">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="complaindescriptiontinput5" rows="5" class="form-control round" name="description"></textarea>
                                            </div>
